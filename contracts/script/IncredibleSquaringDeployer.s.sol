...
import {ICrossMessagingServiceManager, IServiceManager} from "../src/ICrossMessagingServiceManager.sol";
import {CrossMessagingTaskManager} from "../src/CrossMessagingTaskManager.sol";
import {ICrossMessagingTaskManager} from "../src/ICrossMessagingTaskManager.sol";
...
contract IncredibleSquaringDeployer is Script, Utils {
    ...
    ICrossMessagingServiceManager public incredibleSquaringServiceManager;
    IServiceManager public incredibleSquaringServiceManagerImplementation;

    CrossMessagingTaskManager public incredibleSquaringTaskManager;
    ...
    function _deployCredibleSquaringContracts(
         ...
         */
        incredibleSquaringServiceManager = ICrossMessagingServiceManager(
            address(
                new TransparentUpgradeableProxy(
        ...
        incredibleSquaringTaskManager = CrossMessagingTaskManager(
            address(
                new TransparentUpgradeableProxy(
                    address(emptyContract),
                    address(incredibleSquaringProxyAdmin),
        ...
        incredibleSquaringServiceManagerImplementation = new ICrossMessagingServiceManager(
            avsDirectory,
            registryCoordinator,
            stakeRegistry,
        ...
        incredibleSquaringTaskManagerImplementation = new CrossMessagingTaskManager(
            registryCoordinator,
