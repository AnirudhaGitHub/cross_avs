...
import "./ICrossMessagingTaskManager.sol";

contract CrossMessagingTaskManager is
    Initializable,
    OwnableUpgradeable,
    Pausable,
    BLSSignatureChecker,
    ...
    ICrossMessagingTaskManager
{
    ...
    function createNewTask(
        uint256 crossChainMessage,
        uint32 quorumThresholdPercentage,
        bytes calldata quorumNumbers
    ) external onlyTaskGenerator {
        // create a new task struct
        Task memory newTask;
        newTask.crossChainMessage = crossChainMessage;
    ...
    function raiseAndResolveChallenge(
        ...
        uint256 crossChainMessage = task.crossChainMessage;
        // some logical checks
        require(
        ...
        uint256 actualCrossChainMessage = crossChainMessage;
        bool isResponseCorrect = (actualCrossChainMessage ==
            taskResponse.receivedCrossChainMessage);
